...
//           <div className="border-2 border-gray-800 rounded-3xl p-6 sm:p-8 md:p-12 shadow-2xl hover:border-[#0092b8]/50 transition-all duration-500">
...
//                   onBlur={() => setFocusedField(null)}
//                   placeholder="Enter your full name"
//                   className={`w-full px-4 py-3 sm:py-3 bg-black border-2 rounded-lg focus:outline-none transition-all duration-300 ${
//                     focusedField === 'fullName'
//                       ? 'border-[#0092b8] shadow-[0_0_15px_rgba(0,146,184,0.3)]'
//                       : 'border-gray-700 hover:border-gray-600'
//                   }`}
...
//                   onBlur={() => setFocusedField(null)}
//                   placeholder="Tell us about your parking needs..."
//                   className={`w-full px-4 py-3 sm:py-3 bg-black border-2 rounded-lg focus:outline-none transition-all duration-300 resize-none ${
//                     focusedField === 'projectDetails'
//                       ? 'border-[#0092b8] shadow-[0_0_15px_rgba(0,146,184,0.3)]'
//                       : 'border-gray-700 hover:border-gray-600'
//                   }`}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 max-w-3xl mx-auto text-lg">
            Book a demo to see Parking AI in action (5 minutes).
          </p>
        </div>

        {/* Form */}
        <div className="demo-form-container max-w-5xl mx-auto">
          <div className="border-2 border-gray-800 rounded-3xl p-6 md:p-12 shadow-2xl hover:border-[#0092b8]/50 transition-all">
            ...
            >
              {/* Full Name */}
              <div className="form-field">
                <label className="block text-sm mb-2">Full Name  <span className="text-[#0092b8]">*</span></label>
                <input
                  type="text"
                  name="fullName"
                  placeholder="Enter your full name"
              ...
              {/* Email */}
              <div className="form-field">
                <label className="block text-sm mb-2">Email  <span className="text-[#0092b8]">*</span></label>
                <input
                  type="email"
                  name="email"
                  required
              ...
              {/* Company */}
              <div className="form-field">
                <label className="block text-sm mb-2">Company  <span className="text-[#0092b8]">*</span></label>
                <input
                  type="text"
                  name="companyName"
                  required
              ...
              <div className="form-field md:col-span-2">
                <label className="block text-sm mb-2">Timeline <span className="text-[#0092b8]">*</span></label>
                <select
                  name="timeline"
                  required
                  value={formData.timeline}
