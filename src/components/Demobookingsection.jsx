            ...
            >
              ...
              <div className="form-field">
                <label className="block text-sm mb-2">
                  Full Name <span className="text-[#05df72]">*</span>
                </label>
                <input
                  type="text"
                  name="fullName"
              ...
              <div className="form-field">
                <label className="block text-sm mb-2">
                  Email <span className="text-[#05df72]">*</span>
                </label>
                <input
                  type="email"
                  name="email"
              ...
              <div className="form-field">
                <label className="block text-sm mb-2">
                  Company <span className="text-[#05df72]">*</span>
                </label>
                <input
                  type="text"
                  name="companyName"
              ...
              <div className="form-field">
                ...
                >
                  Your Role <span className="text-[#05df72]">*</span>
                </label>
                <div className="relative">
                  <select
                    id="role"
              ...
              <div className="form-field md:col-span-2">
                <label className="block text-sm mb-2">
                  Timeline <span className="text-[#05df72]">*</span>
                </label>
                <select
                  name="timeline"
                  required
