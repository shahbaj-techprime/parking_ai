        ...
        <div className="hero-left text-center md:text-left">
          ...
          {/* <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <button
              ...
              className="bg-[#05df72] px-6 py-3 md:px-8 md:py-4 rounded-lg font-semibold hover:bg-[#04c465] transition text-black"
            >
              Book a Demo Now{" "}
            ...
            <button className="border-2 border-[#05df72] text-[#05df72] px-6 py-3 md:px-8 md:py-4 rounded-lg font-semibold hover:bg-[#05df72]/10 transition">
              Start Free Trial
          <svg
              className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 transition-transform duration-300 group-hover:translate-x-1"
              fill="none"
