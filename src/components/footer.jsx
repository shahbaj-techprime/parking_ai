...
//     // Initialize AOS for tablet+desktop
//     AOS.init({
//       duration: 800,
//       once: true,
//       easing: 'ease-out-cubic',
...
//           {/* Product */}
//           <div className="footer-column text-center sm:text-left" data-aos="fade-up">
//             <h3 className="text-[#0092b8] text-lg font-bold mb-6 uppercase tracking-wide">
//               Product
//             </h3>
...
//           {/* Company */}
//           <div className="footer-column text-center sm:text-left" data-aos="fade-up" data-aos-delay="100">
//             <h3 className="text-[#0092b8] text-lg font-bold mb-6 uppercase tracking-wide">
//               Company
//             </h3>
//             <ul className="space-y-4 sm:space-y-3">
...
//           {/* Resources */}
//           <div className="footer-column text-center sm:text-left" data-aos="fade-up" data-aos-delay="200">
//             <h3 className="text-[#0092b8] text-lg font-bold mb-6 uppercase tracking-wide">
//               Resources
//             </h3>
//             <ul className="space-y-4 sm:space-y-3">
...
//           {/* Trust & Security */}
//           <div className="footer-column text-center sm:text-left" data-aos="fade-up" data-aos-delay="300">
//             <h3 className="text-[#0092b8] text-lg font-bold mb-6 uppercase tracking-wide">
//               Trust & Security
//             </h3>
//             <ul className="space-y-4 sm:space-y-3">
...
//             <a href="#privacy" className="text-gray-400 hover:text-[#0092b8] text-sm">
//               Privacy Policy
//             </a>
//             <span className="text-gray-700">|</span>
//             <a href="#terms" className="text-gray-400 hover:text-[#0092b8] text-sm">
//               Terms of Service
//             </a>
//           </div>
//         </div>
...
//   return (
//     <footer className="bg-[#111317] text-white pt-20 pb-10 px-6 border-t border-gray-900">
//       <div className="max-w-7xl mx-auto">
...
//               AI-powered parking design engine built for India's commercial real estate.
//             </p>
//           </div>
...
//                 {footerData.trustSecurity.map((item, index) => (
//                   <li key={index} className="flex items-center gap-2">
//                     <span className="w-2 h-2 bg-[#0092b8] rounded-full" />
    ...
    <footer className="relative bg-gradient-to-b from-[#0a0b0e] to-[#111317] text-white pt-20 pb-6">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div className="footer-column">
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                <li className="flex items-start gap-2">
                  <svg className="w-4 h-4 mt-0.5 text-[#0092b8] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <a href="mailto:hello@parkingai.in" className="hover:text-[#0092b8] transition-colors">
                    hello@nexelvr.com
                  </a>
                </li>
                <li className="flex items-start gap-2">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
          ...
          <div className="flex items-center gap-6">
            <a href="#privacy" className="text-gray-500 hover:text-[#0092b8] transition-colors">
              Privacy Policy
            </a>
            <span className="text-gray-700">•</span>
            <a href="#terms" className="text-gray-500 hover:text-[#0092b8] transition-colors">
              Terms of Service
            </a>
            {/* <span className="text-gray-700">•</span>
